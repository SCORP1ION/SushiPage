        ...
        <div className={styles.overLay}>
          <div className={styles.container}>
            ...
            <p className={styles.littleDescription}>
              Discover the artistry of seasonal ingredients and masterfully
              crafted sushi in an intimate, luxury setting.
            </p>
            <div className={styles.buttons}>
              <button className={styles.primaryButton}>View Menu</button>
              <button className={styles.secondaryButton}>Reserve table</button>
            </div>
